...
class Player{
	...
	public:
		...
		Player(const std::vector<int>& week_count, const std::vector<int>& limit, const std::vector<int>& count, const int weeks, const int teams, const int div, const int rank);	// Constructor with input
